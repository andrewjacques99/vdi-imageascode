$outfile = "C:\TEMP\VDAServerSetup_2112.exe"
$client = new-object System.Net.WebClient
$client.DownloadFile("https://statlasautomation002.blob.core.windows.net/installers/citrix_files/VDAServerSetup_2112.exe", $outfile)
Start-Process -FilePath $outFile -Argument "/masterimage " -Wait
